...
import com.neu.edu.excel.GridCityExcel;
...
public class GridCityController {
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("demo:gridcity:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<GridCityDTO> list = gridCityService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "", list, GridCityExcel.class);
    }
