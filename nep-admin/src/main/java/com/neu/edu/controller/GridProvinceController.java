...
import com.neu.edu.excel.GridProvinceExcel;
...
public class GridProvinceController {
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("demo:gridprovince:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<GridProvinceDTO> list = gridProvinceService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "", list, GridProvinceExcel.class);
    }
