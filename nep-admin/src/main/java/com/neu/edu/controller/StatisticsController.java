...
import com.neu.edu.excel.StatisticsExcel;
...
public class StatisticsController {
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("demo:statistics:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<StatisticsDTO> list = statisticsService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "", list, StatisticsExcel.class);
    }
