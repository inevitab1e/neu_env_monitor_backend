...
import com.neu.edu.excel.SupervisorExcel;
...
public class SupervisorController {
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("demo:supervisor:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SupervisorDTO> list = supervisorService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "", list, SupervisorExcel.class);
    }
